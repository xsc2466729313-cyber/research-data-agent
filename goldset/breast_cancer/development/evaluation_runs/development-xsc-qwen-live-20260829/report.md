...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.600000 | `EVALUATED` | 15 / 25 | 0.9 |
| `retrieval_recall` | 0.576923 | `EVALUATED` | 15 / 26 | 0.9 |
| `retrieval_f1` | 0.588235 | `EVALUATED` | — | 0.9 |
