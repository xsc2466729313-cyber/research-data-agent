...
- 评测 ID：`official-candidate-qwen-live-recall-v9-20260902`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.937500 | `EVALUATED` | 15 / 16 | 0.9 |
| `retrieval_recall` | 0.833333 | `EVALUATED` | 15 / 18 | 0.9 |
| `retrieval_f1` | 0.882353 | `EVALUATED` | — | 0.9 |
