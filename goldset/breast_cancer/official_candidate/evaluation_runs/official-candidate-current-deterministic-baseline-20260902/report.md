...
- 评测 ID：`official-candidate-current-deterministic-baseline-20260902`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 1.000000 | `EVALUATED` | 18 / 18 | 0.9 |
| `retrieval_recall` | 1.000000 | `EVALUATED` | 18 / 18 | 0.9 |
| `retrieval_f1` | 1.000000 | `EVALUATED` | — | 0.9 |
