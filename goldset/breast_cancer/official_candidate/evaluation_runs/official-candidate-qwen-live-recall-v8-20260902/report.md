...
- 评测 ID：`official-candidate-qwen-live-recall-v8-20260902`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.933333 | `EVALUATED` | 14 / 15 | 0.9 |
| `retrieval_recall` | 0.777778 | `EVALUATED` | 14 / 18 | 0.9 |
| `retrieval_f1` | 0.848485 | `EVALUATED` | — | 0.9 |
