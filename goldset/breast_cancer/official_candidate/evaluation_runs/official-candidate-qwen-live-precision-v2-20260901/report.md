...
- 评测 ID：`official-candidate-qwen-live-precision-v2-20260901`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.888889 | `EVALUATED` | 8 / 9 | 0.9 |
| `retrieval_recall` | 0.444444 | `EVALUATED` | 8 / 18 | 0.9 |
| `retrieval_f1` | 0.592593 | `EVALUATED` | — | 0.9 |
