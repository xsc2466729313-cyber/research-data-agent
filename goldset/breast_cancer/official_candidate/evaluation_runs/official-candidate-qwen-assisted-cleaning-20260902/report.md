...
- 评测 ID：`official-candidate-qwen-assisted-cleaning-20260902`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 1.000000 | `EVALUATED` | 15 / 15 | 0.9 |
| `retrieval_recall` | 0.833333 | `EVALUATED` | 15 / 18 | 0.9 |
| `retrieval_f1` | 0.909091 | `EVALUATED` | — | 0.9 |
| `faithfulness` | 0.461538 | `EVALUATED` | 12 / 26 | 0.95 |
| `traceability` | 0.961538 | `EVALUATED` | 25 / 26 | 1 |
...
- 红线：Faithfulness < 90%
- 发布阻断：1 个关键非空字段缺少完整有效 Evidence
- 发布阻断：9 个实时任务的质量门仍为 REVIEW
