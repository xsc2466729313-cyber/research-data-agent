...
- 评测 ID：`official-candidate-qwen-live-recall-v4-20260901`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.928571 | `EVALUATED` | 13 / 14 | 0.9 |
| `retrieval_recall` | 0.722222 | `EVALUATED` | 13 / 18 | 0.9 |
| `retrieval_f1` | 0.812500 | `EVALUATED` | — | 0.9 |
