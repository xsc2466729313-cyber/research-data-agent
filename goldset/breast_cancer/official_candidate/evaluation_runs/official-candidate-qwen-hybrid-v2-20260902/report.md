...
- 评测 ID：`official-candidate-qwen-hybrid-v2-20260902`
- 评测状态：`EVALUATED`
...
| 指标 | 值 | 状态 | 分子 / 分母 | 目标 |
|---|---:|---|---:|---:|
| `retrieval_precision` | 0.944444 | `EVALUATED` | 17 / 18 | 0.9 |
| `retrieval_recall` | 0.944444 | `EVALUATED` | 17 / 18 | 0.9 |
| `retrieval_f1` | 0.944444 | `EVALUATED` | — | 0.9 |
| `faithfulness` | 0.807692 | `EVALUATED` | 21 / 26 | 0.95 |
