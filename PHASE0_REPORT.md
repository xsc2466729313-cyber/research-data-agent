...
| FastAPI title | Breast Cancer Research Data Agent |
...
执行时间：2026-09-05  
命令：见 `docs/v31_baseline/REGRESSION.md` 的 Phase 0 固定回归集  
...
git diff --name-only -- configs/canonical_schema.yaml configs/medical_rules.yaml
  docs/06_评测指标与SDTI.md docs/EVALUATION_SDTI.md goldset
...
| `docs/06_评测指标与SDTI.md` | `D285926B0D80384F6145B9EBA54FD5D9C6609C8A69F2302440671D5B685D592D` |
