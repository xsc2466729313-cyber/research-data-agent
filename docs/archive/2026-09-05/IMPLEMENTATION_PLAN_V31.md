...
- 前序：`../../V3_UPGRADE_ARCHITECTURE.md`、`PROJECT_AUDIT_REPORT.md`
- 对象：已有成熟系统 research-data-agent
- 日期：2026-09-05
- 性质：实施计划，不是代码，不是重构授权
...
| Gold Set 与 SDTI | `goldset/`、`../../06_评测指标与SDTI.md` |
...
在 `../v31_baseline/` 记录一次“升级前真相”，至少包括：
...
17. `git diff` 不含 `configs/canonical_schema.yaml`、`configs/medical_rules.yaml`、`backend/app/sources/`、Matcher 核心文件、Quality 逻辑文件、`../../06_评测指标与SDTI.md`
