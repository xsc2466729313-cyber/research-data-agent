...
|---|---|---:|---:|---:|---:|
| SciFact | BM25 对照 | 0.6040 | 0.8279 | 0.5689 | 12.60 ms |
| SciFact | 项目当前混合检索 | 0.4070 | 0.7007 | 0.3833 | 18.14 ms |
| NFCorpus | BM25 对照 | 0.2899 | 0.2209 | 0.5020 | 1.93 ms |
| NFCorpus | 项目当前混合检索 | 0.2493 | 0.1937 | 0.4417 | 4.46 ms |

两个数据集上，当前混合检索均没有超过 BM25。SciFact 上的 nDCG@10 低 0.1970，NFCorpus 上低 0.0405。同时，当前方法的查询耗时也更高。
