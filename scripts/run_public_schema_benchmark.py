...
def main() -> None:
    ...
    parser.add_argument("--method", action="append", choices=["exact_normalized_name", "token_jaccard", "project_schema_rule_v1", "project_schema_profile_v2", "project_schema_v3"])
    ...
    for dataset_id in args.dataset or sorted(SCHEMA_DATASETS):
        print(run_public_schema_benchmark(
            ...
            methods=args.method or ("exact_normalized_name", "token_jaccard", "project_schema_rule_v1", "project_schema_profile_v2", "project_schema_v3"),
