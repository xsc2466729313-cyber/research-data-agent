...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.4000 | 0.5714 | 2 | 0 | 3 | 0.132 ms |
| token_jaccard | 1.0000 | 0.6000 | 0.7500 | 3 | 0 | 2 | 0.200 ms |
| project_schema_rule_v1 | 0.7500 | 0.6000 | 0.6667 | 3 | 1 | 2 | 2.084 ms |
| project_schema_profile_v2 | 1.0000 | 1.0000 | 1.0000 | 5 | 0 | 0 | 9.100 ms |
