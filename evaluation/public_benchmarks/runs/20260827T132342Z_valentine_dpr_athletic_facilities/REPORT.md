...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.3000 | 0.4615 | 3 | 0 | 7 | 1.120 ms |
| token_jaccard | 1.0000 | 0.7000 | 0.8235 | 7 | 0 | 3 | 1.591 ms |
| project_schema_rule_v1 | 0.7778 | 0.7000 | 0.7368 | 7 | 2 | 3 | 40.158 ms |
| project_schema_profile_v2 | 0.7143 | 0.5000 | 0.5882 | 5 | 2 | 5 | 127.662 ms |
