...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.4000 | 0.5714 | 2 | 0 | 3 | 0.156 ms |
| token_jaccard | 1.0000 | 0.4000 | 0.5714 | 2 | 0 | 3 | 0.228 ms |
| project_schema_rule_v1 | 0.6667 | 0.4000 | 0.5000 | 2 | 1 | 3 | 3.477 ms |
| project_schema_profile_v2 | 1.0000 | 0.6000 | 0.7500 | 3 | 0 | 2 | 14.914 ms |
