...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.2000 | 0.3333 | 1 | 0 | 4 | 0.208 ms |
| token_jaccard | 1.0000 | 0.8000 | 0.8889 | 4 | 0 | 1 | 0.319 ms |
| project_schema_rule_v1 | 0.8000 | 0.8000 | 0.8000 | 4 | 1 | 1 | 4.436 ms |
| project_schema_profile_v2 | 1.0000 | 1.0000 | 1.0000 | 5 | 0 | 0 | 11.669 ms |
