...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.6667 | 0.8000 | 8 | 0 | 4 | 0.742 ms |
| token_jaccard | 0.8000 | 0.6667 | 0.7273 | 8 | 2 | 4 | 1.159 ms |
| project_schema_rule_v1 | 0.7273 | 0.6667 | 0.6957 | 8 | 3 | 4 | 24.066 ms |
| project_schema_profile_v2 | 1.0000 | 0.7500 | 0.8571 | 9 | 0 | 3 | 83.813 ms |
