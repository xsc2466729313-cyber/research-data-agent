...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.6000 | 0.7500 | 3 | 0 | 2 | 0.268 ms |
| token_jaccard | 1.0000 | 0.6000 | 0.7500 | 3 | 0 | 2 | 0.299 ms |
| project_schema_rule_v1 | 0.7500 | 0.6000 | 0.6667 | 3 | 1 | 2 | 5.455 ms |
| project_schema_profile_v2 | 1.0000 | 1.0000 | 1.0000 | 5 | 0 | 0 | 19.900 ms |
