...
|---|---:|---:|---:|---:|---:|---:|---:|
| exact_normalized_name | 1.0000 | 0.7143 | 0.8333 | 5 | 0 | 2 | 0.385 ms |
| token_jaccard | 1.0000 | 0.8571 | 0.9231 | 6 | 0 | 1 | 0.361 ms |
| project_schema_rule_v1 | 1.0000 | 0.8571 | 0.9231 | 6 | 0 | 1 | 6.206 ms |
| project_schema_profile_v2 | 1.0000 | 0.7143 | 0.8333 | 5 | 0 | 2 | 17.006 ms |
