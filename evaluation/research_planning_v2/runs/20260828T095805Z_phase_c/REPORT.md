...
- Cases: 2
- Evidence case source: `GENERIC_FALLBACK`
- Fallback case source: `GENERIC_FALLBACK`
- Evidence Pack items: 1
- Required fields include reasons: `True`
- Source/raw provenance preserved: `True`
- Qwen invocations: `0` (deterministic implementation; no Qwen call made)
